...
(define* (make-qbitscoin-cross-toolchain target
                                       #:key
...
desirable for building Qbitscoin Core release binaries."
...
;; failure; see https://github.com/qbitscoin/qbitscoin/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-qbitscoin-cross-toolchain target)))
