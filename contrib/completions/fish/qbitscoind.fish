...
complete --command qbitscoind --no-files

# Extract options
function __fish_qbitscoind_get_options
...
complete \
    --command qbitscoind \
    --arguments "(__fish_qbitscoind_get_options --nofiles)"
