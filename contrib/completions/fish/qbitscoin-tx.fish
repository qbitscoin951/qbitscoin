...
# Extract options
function __fish_qbitscoin_tx_get_options
...
# Extract commands
function __fish_qbitscoin_tx_get_commands
...
# Add options
complete \
    --command qbitscoin-tx \
    --condition "not __fish_qbitscoin_seen_cmd (__fish_qbitscoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_qbitscoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command qbitscoin-tx \
    --arguments "(__fish_qbitscoin_tx_get_commands)" \
    --no-files
