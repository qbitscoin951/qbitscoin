...
"""Example logging Qbitscoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/qbitscoind
...
def main(qbitscoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[qbitscoind_with_usdts])
