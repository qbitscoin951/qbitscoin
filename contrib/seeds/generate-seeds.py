...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef QBITSCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define QBITSCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the qbitscoin network\n')
    ...
    g.write('#endif // QBITSCOIN_CHAINPARAMSSEEDS_H\n')
