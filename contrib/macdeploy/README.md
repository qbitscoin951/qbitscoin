...
When complete, it will have produced `Qbitscoin-Core.zip`.
...
apt install cpio
git clone https://github.com/qbitscoin-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/qbitscoin-core/qbitscoin-detached-sigs).
