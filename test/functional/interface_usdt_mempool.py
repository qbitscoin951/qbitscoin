...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/qbitscoin/qbitscoin/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(QbitscoinTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/qbitscoin/qbitscoin/issues/27380
