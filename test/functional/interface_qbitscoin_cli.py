...
class TestQbitscoinCli(QbitscoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `qbitscoin-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and qbitscoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and qbitscoin-cli getwalletinfo return expected wallet info")
            ...
            # Test qbitscoin-cli -generate with -rpcwallet in multiwallet mode.
