#!/usr/bin/env python3
# Copyright (c) 2017-present The Qbitscoin Core developers
...
class NetTest(QbitscoinTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=8663)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 8663)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=8663), {"success": False})
