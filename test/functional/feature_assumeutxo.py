#!/usr/bin/env python3
# Copyright (c) 2021-present The Qbitscoin Core developers
...
to a hash that has been compiled into qbitscoind.
...
class AssumeutxoTest(QbitscoinTestFramework):
    ...
    def test_invalid_mempool_state(self, dump_output_path):
        self.log.info("Test qbitscoind should fail when mempool not empty.")
        node=self.nodes[2]
