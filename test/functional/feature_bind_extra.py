...
"""
Test starting qbitscoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(QbitscoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that qbitscoind has bound on "::1" (for RPC) and "::" (for P2P).
