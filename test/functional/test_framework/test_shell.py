...
class TestShell:
    """Wrapper Class for QbitscoinTestFramework.

    The TestShell class extends the QbitscoinTestFramework
    ...
    class __TestShell(QbitscoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by QbitscoinTestFramework child class.
            self.num_nodes = 1
