...
Verify that a qbitscoind node can use an external signer command.
...
class RPCSignerTest(QbitscoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart qbitscoind with -signer=<cmd>',
