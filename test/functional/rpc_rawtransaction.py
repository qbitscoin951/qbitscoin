...
class RawTransactionsTest(QbitscoinTestFramework):
    ...
    def getrawtransaction_verbosity_tests(self):
        ...
        # Do this with a pruned chain, as a regression test for https://github.com/qbitscoin/qbitscoin/pull/29003
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Qbitscoin address", self.nodes[0].createrawtransaction, [], {'foo': 0})
    ...
    def decoderawtransaction_tests(self):
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/qbitscoin/qbitscoin/issues/20579)
