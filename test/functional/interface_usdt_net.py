...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/qbitscoin/qbitscoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(QbitscoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our qbitscoind node")
