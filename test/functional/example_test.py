...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the QbitscoinTestFramework
    pass


class ExampleTest(QbitscoinTestFramework):
    # Each functional test is a subclass of the QbitscoinTestFramework class.
    ...
    def custom_method(self):
        ...
        QbitscoinTestFramework class so other tests can use it."""
