...
class RawTransactionsTest(QbitscoinTestFramework):
    ...
    def test_invalid_change_address(self):
        ...
        assert_raises_rpc_error(-5, "Change address must be a valid qbitscoin address", self.nodes[2].fundrawtransaction, rawtx, changeAddress='foobar')
    ...
    def test_feerate_rounding(self):
        ...
        # fail with insufficient funds rather than qbitscoind asserting.
