...
By default, qbitscoind will dump mempool on shutdown and
...
class MempoolPersistTest(QbitscoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent qbitscoind from writing mempool.dat to disk. Verify that `savemempool` fails")
