...
The project's collection of seed corpora is found in the [`qbitscoin-core/qa-assets`](https://github.com/qbitscoin-core/qa-assets) repo.

To fuzz `process_message` using the [`qbitscoin-core/qa-assets`](https://github.com/qbitscoin-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/qbitscoin-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`qbitscoin-core/qa-assets`](https://github.com/qbitscoin-core/qa-assets) repo.

Every single pull request submitted against the Qbitscoin Core repo is automatically tested against all inputs in the [`qbitscoin-core/qa-assets`](https://github.com/qbitscoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Qbitscoin Core more robust.
