...
This document provides guidelines for internationalization of the Qbitscoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `qbitscoin_en.ts` remains unchanged.
