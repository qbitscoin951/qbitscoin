Qbitscoin Core version 0.16.1 is now available from:

  <https://qbitscoincore.org/bin/qbitscoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting qbitscoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure qbitscoind processes are cleaned up when tests end (sdaftuar)
