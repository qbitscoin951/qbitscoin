Qbitscoin Core version *0.15.0.1* is now available from:

  <https://qbitscoin.org/bin/qbitscoin-core-0.15.0.1/>

and

  <https://qbitscoincore.org/bin/qbitscoin-core-0.15.0.1/>
