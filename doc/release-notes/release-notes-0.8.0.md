Qbitscoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/qbitscoin/files/Qbitscoin/qbitscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Qbitscoin
...
New/changed settings (command-line or qbitscoin.conf file)
--------------------------------------------------------
