Qbitscoin Core version *0.15.2* is now available from:

  <https://qbitscoincore.org/bin/qbitscoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in qbitscoin-tx (TheBlueMatt)
