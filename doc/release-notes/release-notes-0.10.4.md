Qbitscoin Core version 0.10.4 is now available from:

  <https://qbitscoin.org/bin/qbitscoin-core-0.10.4/>
...
- #6953 `43c2789` Split qbitscoin-tx into its own package
- #6953 `dfe0d4d` Include qbitscoin-tx binary on Debian/Ubuntu
