Qbitscoin Core version 0.13.2 is now available from:

  <https://qbitscoin.org/bin/qbitscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update qbitscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow qbitscoin-tx to create v2 transactions (btcdrak)
