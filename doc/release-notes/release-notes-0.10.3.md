Qbitscoin Core version 0.10.3 is now available from:

  <https://qbitscoin.org/bin/qbitscoin-core-0.10.3/>
...
(see https://github.com/qbitscoin/qbitscoin/pull/6793, as well as the 0.11.0
