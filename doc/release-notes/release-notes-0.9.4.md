Qbitscoin Core version 0.9.4 is now available from:

  https://qbitscoin.org/bin/0.9.4/
...
this update is incompatible with the Qbitscoin system and could lead to consensus
forks.

Qbitscoin Core released binaries from https://qbitscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~qbitscoin/+archive/ubuntu/qbitscoin
- A third-party or self-compiled Qbitscoin Core

upgrade to Qbitscoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
