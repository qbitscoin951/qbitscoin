Qbitscoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/qbitscoin/files/Qbitscoin/qbitscoin-0.5.4/
...
http://gitorious.org/qbitscoin/qbitscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Qbitscoin-Qt notifications under Growl 1.3.
Increase required age of Qbitscoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxQbitscoin properly when installing Qbitscoin-Qt over it. (Windows)
