...
#ifndef QBITSCOIN_INTERFACES_NODE_H
#define QBITSCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a qbitscoin node (qbitscoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or qbitscoin.conf.
...
#endif // QBITSCOIN_INTERFACES_NODE_H
