...
#ifndef QBITSCOIN_INTERFACES_INIT_H
#define QBITSCOIN_INTERFACES_INIT_H
...
//! (qbitscoin-gui, qbitscoin-node, qbitscoin-wallet, qbitscoind, qbitscoin-qt) and each
...
#endif // QBITSCOIN_INTERFACES_INIT_H
