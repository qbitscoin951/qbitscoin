...
#ifndef QBITSCOIN_QT_QBITSCOINGUI_H
#define QBITSCOIN_QT_QBITSCOINGUI_H
...
/**
  Qbitscoin GUI main class. This class represents the main window of the Qbitscoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class QbitscoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit QbitscoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~QbitscoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a qbitscoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, QbitscoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Qbitscoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(QbitscoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // QBITSCOIN_QT_QBITSCOINGUI_H
