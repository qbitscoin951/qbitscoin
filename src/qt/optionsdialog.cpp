      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->qbitscoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->qbitscoinAtStartup);
    ...
    ui->qbitscoinAtStartup->setToolTip(ui->qbitscoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->qbitscoinAtStartup->setText(ui->qbitscoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openQbitscoinConfButton->setToolTip(ui->openQbitscoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new QbitscoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->qbitscoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openQbitscoinConfButton_clicked()
{
