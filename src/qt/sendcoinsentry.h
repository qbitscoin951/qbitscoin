...
#ifndef QBITSCOIN_QT_SENDCOINSENTRY_H
#define QBITSCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending qbitscoins.
 */
...
#endif // QBITSCOIN_QT_SENDCOINSENTRY_H
