...
#ifndef QBITSCOIN_QT_OPTIONSMODEL_H
#define QBITSCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Qbitscoin client.
...
public:
    ...
    QbitscoinUnit getDisplayUnit() const { return m_display_qbitscoin_unit; }
...
private:
    ...
    QString language;
    QbitscoinUnit m_display_qbitscoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(QbitscoinUnit unit);
...
#endif // QBITSCOIN_QT_OPTIONSMODEL_H
