...
{
    // Test regression https://github.com/qbitscoin/qbitscoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/qbitscoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/qbitscoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Qbitscoin/Qbitscoin-Qt.conf and all else left as default,
    // qbitscoin-qt should set both -listen and -listenonion to false and start successfully.
