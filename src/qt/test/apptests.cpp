...
//! Entry point for QbitscoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &QbitscoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for QbitscoinGUI tests.
void AppTests::guiTests(QbitscoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &QbitscoinGUI::consoleShown, this, &AppTests::consoleTests);
