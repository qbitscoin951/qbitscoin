...
#ifndef QBITSCOIN_QT_GUIUTIL_H
#define QBITSCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Qbitscoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "qbitscoin:" URI into recipient object, return true on successful parsing
