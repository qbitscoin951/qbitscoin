...
#ifndef QBITSCOIN_ARITH_UINT256_H
#define QBITSCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Qbitscoin only uses this "compact" format for encoding difficulty
...
#endif // QBITSCOIN_ARITH_UINT256_H
