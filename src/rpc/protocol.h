...
#ifndef QBITSCOIN_RPC_PROTOCOL_H
#define QBITSCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in qbitscoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Qbitscoin is not connected
...
#endif // QBITSCOIN_RPC_PROTOCOL_H
