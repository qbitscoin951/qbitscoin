...
#ifndef QBITSCOIN_NODE_CONNECTION_TYPES_H
#define QBITSCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/qbitscoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Qbitscoin’s Peer-to-Peer Network")
...
#endif // QBITSCOIN_NODE_CONNECTION_TYPES_H
