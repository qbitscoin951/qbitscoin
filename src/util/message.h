...
#ifndef QBITSCOIN_UTIL_MESSAGE_H
#define QBITSCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's qbitscoin address, it must refer to a public key.
...
#endif // QBITSCOIN_UTIL_MESSAGE_H
