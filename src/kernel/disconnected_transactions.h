...
#ifndef QBITSCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define QBITSCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // QBITSCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
