...
#ifndef QBITSCOIN_TEST_SCRIPTNUM10_H
#define QBITSCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Qbitscoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // QBITSCOIN_TEST_SCRIPTNUM10_H
