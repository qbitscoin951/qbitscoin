...
{
    BOOST_CHECK(TestSplitHost("www.qbitscoincore.org", "www.qbitscoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.qbitscoincore.org]", "www.qbitscoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.qbitscoincore.org:80", "www.qbitscoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.qbitscoincore.org]:80", "www.qbitscoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8663", "127.0.0.1", 8663));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8663", "127.0.0.1", 8663));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8663", "::ffff:127.0.0.1", 8663));
    BOOST_CHECK(TestSplitHost("[::]:8663", "::", 8663));
    BOOST_CHECK(TestSplitHost("::8663", "::8663", 0));
    BOOST_CHECK(TestSplitHost(":8663", "", 8663));
    BOOST_CHECK(TestSplitHost("[]:8663", "", 8663));
    ...
    BOOST_CHECK(TestSplitHost("www.qbitscoincore.org:65536", "www.qbitscoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.qbitscoincore.org:0", "www.qbitscoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.qbitscoincore.org:", "www.qbitscoincore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8663", "127.0.0.1:8663"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8663", "[::]:8663"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
