...
The library primarily serves the needs of the Qbitscoin Core project but provides additional functionality for the benefit of the wider Qbitscoin ecosystem.
...
* **Relevance Arguments:**
    The relevance of the new functionality for the Qbitscoin ecosystem should be argued by outlining clear use cases.
...
The Contributor Workflow & Peer Review in libsecp256k1 are similar to Qbitscoin Core's workflow and review processes described in its [CONTRIBUTING.md](https://github.com/qbitscoin/qbitscoin/blob/master/CONTRIBUTING.md).
...
* Use `secp256k1_memcmp_var` instead of `memcmp` (see [#823](https://github.com/qbitscoin-core/secp256k1/issues/823)).
