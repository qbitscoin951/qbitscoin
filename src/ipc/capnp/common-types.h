...
#ifndef QBITSCOIN_IPC_CAPNP_COMMON_TYPES_H
#define QBITSCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common qbitscoin types.
namespace mp {
...
#endif // QBITSCOIN_IPC_CAPNP_COMMON_TYPES_H
