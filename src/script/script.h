...
// Copyright (c) 2009-present The Qbitscoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef QBITSCOIN_SCRIPT_SCRIPT_H
#define QBITSCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Qbitscoin always counted CHECKMULTISIGs
...
#endif // QBITSCOIN_SCRIPT_SCRIPT_H
