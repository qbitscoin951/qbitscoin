...
#ifndef QBITSCOIN_WALLET_TRANSACTION_H
#define QBITSCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this qbitscoin node, and set to 0 for transactions that were created
...
#endif // QBITSCOIN_WALLET_TRANSACTION_H
