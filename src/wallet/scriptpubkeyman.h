...
#ifndef QBITSCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define QBITSCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Qbitscoin Core wallet was originally a collection of unrelated private
...
#endif // QBITSCOIN_WALLET_SCRIPTPUBKEYMAN_H
