...
#ifndef QBITSCOIN_WALLET_WALLETUTIL_H
#define QBITSCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! qbitscoin from opening the wallet, thinking it was newly created, and
...
#endif // QBITSCOIN_WALLET_WALLETUTIL_H
