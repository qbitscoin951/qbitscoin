...
#ifndef QBITSCOIN_WALLET_WALLET_H
#define QBITSCOIN_WALLET_WALLET_H
...
public:
     ...
     * qbitscoin-wallet tool code or by wallet migration code. If this is called
...
#endif // QBITSCOIN_WALLET_WALLET_H
