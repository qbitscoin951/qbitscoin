...
#ifndef QBITSCOIN_PROTOCOL_H
#define QBITSCOIN_PROTOCOL_H
...
/**
 * Qbitscoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Qbitscoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // qbitscoin-development mailing list. Remember that service bits are just
