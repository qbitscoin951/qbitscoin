...
#ifndef QBITSCOIN_COMMON_ARGS_H
#define QBITSCOIN_COMMON_ARGS_H
...
extern const char * const QBITSCOIN_CONF_FILENAME;
extern const char * const QBITSCOIN_SETTINGS_FILENAME;
